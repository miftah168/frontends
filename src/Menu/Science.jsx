...
class Science extends React.Component {
    ...
    componentDidMount() {
        fetch(
            "https://newsapi.org/v2/top-headlines/sources?apiKey=64c5960e7efa4d60a3c4a3f8ebd82fb0&category=science")
            .then((res) => res.json())
            .then((json) => {
                this.setState({
                    items: json,
...
<div className="row g-4">
 ...
 <div className="service-item rounded overflow-hidden">
   <div className="position-relative p-4 pt-0">
     ...
     <h4 className="mb-3" key={row.name}>{ row.name }</h4>
     <p>
       {row.description}
     </p>
